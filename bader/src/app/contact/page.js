...
نرحب بتواصلكم معنا في مشروع بادر  لإصلاح مشاكل الحي.             </p>
              ...
              {isSubmitted ? (
                ...
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#fa9e1b] mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 [#31124b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold [#31124b] mb-2 font-arabic">تم إرسال رسالتك بنجاح!</h3>
                  <p className="text-[#31124b] font-arabic">سنتواصل معك قريباً</p>
                </motion.div>
              ) : (
              ...
              <div className="pt-6">
                ...
                <div className="flex gap-4 justify-start">
                  <motion.a 
                    ...
                    whileHover={{ y: -5 }}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 [#31124b]" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-right">
              <h3 className="text-2xl font-bold  text-amber-50 mb-5  font-arabic">هل لديك مشكلة في حيك؟</h3>
              <p className="text-amber-50 mt-5 font-arabic">بادر بالإبلاغ عن المشكلة وسنعمل على حلها في أقرب وقت ممكن</p>
            </div>
            <motion.a 
              href="/report-issue" 
