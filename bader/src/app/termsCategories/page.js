    ...
    <div className="min-h-screen bg-gradient-to-br font-sans">
      ...
      <main className="max-w-4xl mx-auto py-12 px-4" dir='rtl'>
        ...
        <section className="mb-12 bg-white rounded-lg p-8 shadow-md border-r-4 border-orange-400">
          <h2 className="text-2xl font-bold text-[#31124b] mb-4">مرحباً بك في منصة "بادر"</h2>
          <p className="text-gray-700 leading-relaxed">
            نشكرك على اهتمامك بالانضمام إلى مجتمعنا التطوعي. قبل البدء في استخدام منصتنا والمشاركة في المبادرات التطوعية لإصلاح الأحياء، يرجى قراءة شروط الخدمة التالية بعناية. تهدف هذه الشروط إلى توضيح حقوق والتزامات جميع الأطراف المشاركة في المنصة وضمان تجربة إيجابية وآمنة للجميع.
          </p>
          <div className="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-md">
            <div className="flex items-center">
              <CheckCircle className="w-5 h-5 text-orange-500 ml-2" />
              <p className="text-orange-700 font-medium">
                بتسجيلك واستخدامك للمنصة، فإنك تقر بأنك قرأت وفهمت ووافقت على الالتزام بجميع الشروط والأحكام الواردة أدناه.
              </p>
            </div>
          </div>
        </section>
              ...
              >
                <button
                  ...
                  className={`w-full flex items-center justify-between p-5 text-right ${
                    expandedSection === category.id ? 'bg-[#31124b] text-white' : 'bg-white text-[#31124b] hover:bg-purple-50'
                  ...
                  <div className="p-5 border-t border-gray-200">
                    <div className="space-y-6">
                      {category.content.map((item, index) => (
                        <div key={index}>
                          <h4 className="text-lg font-semibold text-[#31124b] mb-2">{item.title}</h4>
        ...
        <section className="bg-white rounded-lg p-8 shadow-md">
          <h3 className="text-2xl font-bold text-[#31124b] mb-4">هل لديك استفسارات؟</h3>
