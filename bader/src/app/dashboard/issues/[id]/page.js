...
import { Trash2, Save, Plus, RefreshCw, MapPin, AlertTriangle, Upload, Users, DollarSign } from "lucide-react";
          ...
          <div className="lg:col-span-2">
            <div className="bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
              ...
              <div className="p-5 space-y-5">
                <div>
                  <label className="block font-semibold text-gray-700 mb-1">نوع المشكلة:</label>
                  <select
                    name="problemType"
                ...
                <div>
                  <label className="block font-semibold text-gray-700 mb-1">الوصف:</label>
                  <textarea
                    name="description"
                ...
                <div className="flex items-center">
                  <div className="flex-grow">
                    <label className="block font-semibold text-gray-700 mb-1">الموقع:</label>
                ...
                <div>
                  <label className="block font-semibold text-gray-700 mb-1">درجة الخطورة:</label>
                  <div className="flex space-x-1 justify-between rtl:space-x-reverse">
                    {["low", "medium", "high"].map((level) => {
                      ...
                      const colorClasses = {
                        low: isSelected ? "bg-green-500 border-green-500 text-white" : "bg-white text-green-500 border-green-500",
                        medium: isSelected ? "bg-amber-500 border-amber-500 text-white" : "bg-white text-amber-500 border-amber-500",
                        high: isSelected ? "bg-red-500 border-red-500 text-white" : "bg-white text-red-500 border-red-500",
                      };
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block font-semibold text-gray-700 mb-1">قيمة التبرع المطلوبة:</label>
                    <div className="relative">
                      <input
                        type="number"
                        name="donationTarget"
                  ...
                  <div>
                    <label className="block font-semibold text-gray-700 mb-1">عدد المتطوعين المطلوبين:</label>
                    <div className="relative">
                      <input
                        type="number"
                        name="volunteerCount"
            ...
            <div className="mt-6 bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
              ...
              <div className="p-5">
                <div className="mb-4">
                  <label className="block font-semibold text-gray-700 mb-2">إضافة صور جديدة:</label>
                  <div className="relative">
                    <input
                      type="file"
                      multiple
                    ...
                    <div className="flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg py-4 px-6 bg-gray-50 hover:bg-gray-100 transition-colors">
                      ...
                      <span className="text-gray-600">اسحب الصور هنا أو اضغط للتحميل</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  <label className="block font-semibold text-gray-700 mb-2">الصور المرفقة ({issue.images?.length || 0}):</label>
              ...
              <div className="p-5">
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between">
                    <span className="font-semibold text-gray-600">تاريخ البلاغ:</span>
                    <span>{new Date(issue.createdAt).toLocaleString("ar-EG")}</span>
                  </div>
                </div>

                <div className="my-6">
                  <div className={`rounded-lg p-3 border ${getSeverityBadgeColor(formData.severityLevel)}`}>
