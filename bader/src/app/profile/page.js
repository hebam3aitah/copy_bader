...
export default function UserProfile() {
  ...
  const totalVolunteerHours = completedProjects.length || 0;
                ...
                <div className="bg-gradient-to-br from-[#31124b] to-[#42195e] rounded-lg p-4 text-white">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-xs opacity-75">جميع المشاريع</p>
        ...
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <div className="flex justify-center mt-2 space-x-4 space-x-reverse">
              <button className="hover:text-[#fa9e1b] transition-colors">
                المساعدة
              </button>
              <button className="hover:text-[#fa9e1b] transition-colors">
                الشروط والأحكام
